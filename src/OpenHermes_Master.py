...
# =================================================================
# DETAILED MASTER SCRIPT: OPENHERMES-2.5-MISTRAL-7B
# =================================================================
MODEL_ID = "teknium/OpenHermes-2.5-Mistral-7B"
SHORT_NAME = "OPENHERMES_2_5"

LAYER_IDX = 20         
N_CONCEPTS = 2000      
SAMPLES_PER_DOMAIN = 500 

print(f"🧠 INITIALIZING DETAILED MAP MAPPING: {MODEL_ID}")
...
with torch.no_grad():
    # Mistral architecture perfectly matches the up_proj structure
...
print(f"\n[3/5] Initiating OpenHermes Sequence...")
...
plt.title(f"OPENHERMES COGNITIVE MAP (2000 Nodes)\n{MODEL_ID}", fontsize=40)
plt.axis('off')
map_file = f"DETAILED_MAP_{SHORT_NAME}.png"
plt.savefig(map_file, dpi=300, bbox_inches='tight') 

print(f"\n✅ STUDY 100% COMPLETE! YOU PROFILED THE OPENHERMES MODEL.")
